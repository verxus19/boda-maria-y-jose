...
const translations = {
  es: {
    ...
    preboda_intro:        "El viernes 23 de octubre, quien quiera puede acercarse al bar La Bacalona para tomar algo. Nada formal: unas cervecitas (sin pasarse, que hay que reservarse para la boda jejeje) y buena compa\u00f1\u00eda.<br><br>No olvides confirmarlo en el formulario de asistencia.",
    preboda_event_title:  "Preboda",
    preboda_event_place:  "Centro de Sevilla \u00b7 La Bacalona",
  ...
  en: {
    ...
    preboda_intro:        "On Friday, October 23, anyone who would like to is welcome to join us at La Bacalona for a drink. Nothing formal: a few beers (don\u2019t overdo it\u2014we need to save ourselves for the wedding, haha) and good company.<br><br>Don\u2019t forget to confirm on the attendance form.",
    preboda_event_title:  "Pre-wedding",
    preboda_event_place:  "Seville city centre \u00b7 La Bacalona",
